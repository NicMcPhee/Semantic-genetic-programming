...
class MutationTest {
	...
	public void simpleMutation() {
		...
		def P1Evolver = new Evolver([Operator.plus, Operator.sub], [], 0, 4, 5, 4, 20)
	...
	public void complexMutation() {
		...
		def P1Evolver = new Evolver([Operator.gpif, Operator.sub, Operator.mult, Operator.sin, Operator.divi, Operator.cos], ['x'], 10, 5, 8, 20, 15)
